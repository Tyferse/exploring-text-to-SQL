...
[**ReFoRCE**](https://github.com/Tyferse/exploring-text-to-SQL/tree/main/data/Spider2/methods/ReFoRCE) представляет собой цикл исправления с применением генерации вспомогательных запросов. Алгоритм:
