...
| DIN-SQL [62]                   | S                 | -      | S       | T      | T              | T      | S                 | -        |
| DAIL-SQL [63]                  | -                 | -      | -       | T      | -              | -      | -                 | T        |
| MCS-SQL [83]                   | S                 | -      | T       | S + T  | -              | -      | -                 | S        |
| CHESS [51]                     | A                 | -      | T + A   | -      | -              | -      | A                 | A        |
| Distillery [84]                | -                 | S      | -       | -      | -              | -      | S                 | T        |
| CHASE-SQL [53]                 | T + S             | -      | T + S   | -      | S              | -      | S                 | S        |
| RSL-SQL [85]                   | T + S             | -      | T       | T + S  | S              | -      | S                 | S        |
| Spider Agent [47]              | A                 | -      | A       | -      | -              | -      | A                 | -        |
| ReFoRCE [56]                   | T + S             | -      | A       | -      | -              | -      | S                 | T        |
| LinkAlign [86]                 | S, A              | S, A   | -       | -      | T, A           | -      | -                 | -        |
| OpenSearch-SQL [52]            | T + S             | -      | T       | T + S  | -              | S      | A                 | T        |
| N-rep [87]                     | S                 | -      | -       | T      | -              | -      | -                 | T + S    |
| AskData [88]                   | T + S             | -      | T       | S      | -              | -      | T + S             | T        |
| AutoLink [57]                  | T + A             | -      | A       | -      | -              | -      | S                 | T + S    |
| DSR-SQL [59]                   | T + S             | S      | S       | T      | A              | -      | A                 | -        |
| APEX-SQL [60]                  | S                 | -      | A       | S      | T + S          | -      | A                 | S        |
| Rethinking Schema Linking [89] | S                 | -      | T       | -      | S              | -      | -                 | -        |
| MCI-SQL [90]                   | S                 | -      | T       | T + S  | -              | -      | S                 | T        |
| SchemaGraphSQL [91]            | T + S             | -      | -       | -      | -              | -      | -                 | -        |
| AV-SQL [92]                    | T + A             | S      | T       | -      | A              | -      | A                 | -        |
| AgentSM [93]                   | T + A             | -      | -       | T + S  | A              | -      | A                 | -        |
