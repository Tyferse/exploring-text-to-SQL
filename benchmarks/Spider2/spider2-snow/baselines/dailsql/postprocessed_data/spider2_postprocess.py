...
sys.path.insert(0, osp.join(proj_dir, '../utils/'))

from dailsql.utils.enums import LLM
from post_utils import main_postprocess


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--dev', default='spider2_dev', type=str, help='the name of dev file')
    parser.add_argument('--model', default=LLM.QWEN3_CODER, type=str)
