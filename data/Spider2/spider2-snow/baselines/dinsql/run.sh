...
cd ${eval_suite_dir}
python evaluate.py --mode sql --result_dir ${script_dir}/postprocessed_data/${DEV}/predicted-SQL-postprocessed --gold_dir /content/ttsql/data/Spider2/spider2-lite/evaluation_suite/gold
